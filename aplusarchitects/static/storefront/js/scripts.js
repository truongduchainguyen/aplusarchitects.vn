...
function initMonolit() {
 ...
 var timestamp_mousewheel = 0;
    ...
    function showLanguage() {
        $(".language-inner").addClass("show-lang");
        $(".show-language").removeClass("is-show");
        setTimeout(function() {
            $("header").addClass("vis-header-b");
        }, 400);
    }
    ...
    function hideLanguage() {
        $(".language-inner").removeClass("show-lang");
        $(".show-language").addClass("is-show");
        $("header").removeClass("vis-header-b");
    }
    
    $(".show-language").on("click", function(e) {
        e.preventDefault();
        if ($(".show-language").hasClass("is-show")){
            showLanguage();
        } else {
            hideLanguage();
        }
    ...
    $("#language-form .language-item").on("click", function(e) {
        e.preventDefault();
        var option = $(e.currentTarget);
        var lang_code = option.data('lang');
        $('#language-form input[name="language"]').val(lang_code);
        setTimeout(() => {
